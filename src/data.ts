...
const REAL_COS_DATA: COSData = {
  ...
  projects: [
    ...
    },
    {
      ...
      due: null, lastMovement: "Decided Ollin is chat-first",
      ...
      decisionsList: [
        { t: "Ollin is chat-first", d: "One calm input, always present. Ask and capture in one place.", when: "yesterday" },
        { t: "Continue where you left off is the north star", d: "Re-entry over everything else.", when: "4 days ago" },
      ],
      knowledgeList: [
        { t: "Context is computed, not stored", d: "If users maintain it by hand, it goes stale and lies.", used: "Ollin" },
        { t: "Forgetting is a feature", d: "Re-entry must also let things die gracefully.", used: "Ollin" },
      ],
      peopleList: [
    ...
    },
    {
      ...
      openDecisions: ["Own brand, or a mode inside Ollin?"],
      nextAction: "Decide: standalone brand, or a ritual inside Ollin.",
  ...
  ideas: [
    { id: "relos", name: "Relationship OS", stage: "Brewing", why: "Keep relationships warm at scale without it feeling transactional.",
      ...
      questions: ["Is this part of Ollin or its own thing?", "Who is it for first — friends, or clients?"],
      related: ["Ollin"], lastActivity: "4 days ago", lastMove: "Sketched the 'warm list' concept",
    ...
    { id: "agent", name: "New Agent Concept", stage: "Brewing", why: "Ollin's assistant, productized for other people's context.",
      heat: "Hot", heatNote: "5 notes this week — this one wants out.",
      questions: ["Does it compete with Ollin or extend it?", "Is it a feature or a company?"],
      related: ["Ollin", "GLVE"], lastActivity: "yesterday", lastMove: "Wrote 5 notes on the agent's job",
      spark: "If Ollin can hold my context, it can hold anyone's — and the assistant that reads it is the real product.",
      nextMove: "Write the one-paragraph pitch and pressure-test it." },
  ],
  sparks: ["Voice-first journaling", "Family archive", "Ollin for teams", "Newsletter engine", "A book on continuity"],
  activity: [
    { proj: "Ollin", accent: "mint", verb: "Decided", what: "Ollin is chat-first", when: "yesterday" },
  ...
  searchKnowledge: [
    ...
    { t: "Context is computed, not stored", d: "Maintain it by hand and it goes stale.", used: "Ollin" },
  ...
  searchDecisions: [
    ...
    { t: "Ollin is chat-first", used: "Ollin" },
  ...
  lab: {
    ...
    agents: [
      ...
      { initials: "AR", name: "Archivist", accent: "amber", status: "field",
        ...
        finding: "Ollin became chat-first on June 7.",
        last: "yesterday" },
      ...
      { initials: "FB", name: "Founder Briefing", accent: "violet", status: "reporting",
        ...
        finding: "Recruiting OS is waiting on candidate exports. Ollin homepage direction is still active. Matt follow-up remains open.",
        last: "just now" },
